...
def generate_json_data(output_json):
    player_stats = {}
    ...
    with open(output_json, 'w') as json_file:
        json.dump(player_stats, json_file)
    print(f"JSON data generated successfully: {output_json}")

# Usage
output_json = 'player_stats.json'
generate_json_data(output_json)
